...
import com.wings2d.editor.objects.EditorAnimation;
	    	...
	    	public void actionPerformed(ActionEvent e){  
	    		...
	    		if (result == JFileChooser.APPROVE_OPTION) 
	    		{
	    			...
	    			try {
	    				...
	    				editor.setActiveSprite(new EditorSpriteSheet(in, editor.getDemoLevel()));
...
//	    				in.close();
	    ...
	    newButton.addActionListener(new ActionListener(){  
	    	public void actionPerformed(ActionEvent e){ 
	    		...
	    		editor.setActiveSprite(new EditorSpriteSheet(spriteName, editor.getDemoLevel()));
	        }  
	    }); 
